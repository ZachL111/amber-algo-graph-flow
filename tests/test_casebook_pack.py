"""Regression checks for the amber-algo-graph-flow casebook."""
...
from casebook.harness import assert_expected, amber_algo_graph_flow_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(amber_algo_graph_flow_summary(), assert_expected())
